...
class Listing
{
    public $id, $title, $description, $portions, $time_from, $time_until, $allergen, $diet, $restaurant, $image ;
    function setListingFromId($id) {
        ...
        if ($result = $conn->query($query)) {
            ...
            $result = mysqli_query($conn, $restaurantquery);
            $this->restaurant = mysqli_fetch_assoc($result)['name'];
